...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState(['example@gmail.com'])
            ...
            <form onSubmit={addNewEmailToInvite} className="p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
              <div className="flex items-center flex-1 px-2 gap-2">
                ...
                <input 
                  type="email" 
                  name="email" 
                  placeholder="Enter the email of the guest" 
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">
                To complete the creation of your trip to <span className="text-zinc-100 font-semibold">Florianópolis, Brazil</span> from <span className="text-zinc-100 font-semibold">August 16 to 27, 2024</span>, please fill in your details below:
              </p>
            </div>
